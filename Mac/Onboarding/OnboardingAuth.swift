...
//                    }).buttonStyle(.plain).frame(width: 375, height: 30)
                    ...
                    }.pickerStyle(.segmented).background(Color(red: 46 / 255, green: 46 / 255, blue: 46 / 255))
                    HStack {
                        if signUp {
                            TextField("username...", text: $username).background(Color(red: 46 / 255, green: 46 / 255, blue: 46 / 255))
                        }
                        TextField("email...", text: $email).background(Color(red: 46 / 255, green: 46 / 255, blue: 46 / 255))
                        SecureField("password...", text: $password).background(Color(red: 46 / 255, green: 46 / 255, blue: 46 / 255))
                        Button(action: {
                            if signUp {
                                if validateUsername() {
                                    Task {
